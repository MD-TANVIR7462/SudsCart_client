...
const ProductCard = ({ singleProduct }: { singleProduct: Tproduct }) => {
  return (
    <Link href={`/dishwashing-items/${singleProduct._id}`}>
      <div className="text-white relative w-full sm:w-[80%] mx-auto md:w-full shadow-lg hover:shadow-xl hover:transform hover:scale-105 duration-300    rounded-3xl p-2  my-3 cursor-pointer">
        <div className="overflow-x-hidden rounded-2xl relative">
          ...
          />
          <p className="absolute right-2 top-2  rounded-full p-2 cursor-pointer group">
            <svg
